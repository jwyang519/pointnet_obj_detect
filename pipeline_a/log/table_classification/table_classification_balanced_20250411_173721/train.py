...
def main(args):
    ...
    # Calculate more balanced weights
    if args.use_weights:
        ratio = num_table / num_non_table
        # More balanced weights: instead of 15x, use square root of ratio
        non_table_weight = min(5.0, np.sqrt(ratio) * 3)  # Cap at 5, use sqrt of ratio
        table_weight = 1.0
