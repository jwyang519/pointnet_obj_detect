...
def plot_training_curves(epochs, train_losses, test_losses, train_accs, test_accs, 
    ...
    plt.plot(epochs, test_table_accs, 'r-', label='Test Table Accuracy')
    ...
    plt.plot(epochs, test_non_table_accs, 'r-', label='Test Non-Table Accuracy')
...
def main(args):
    ...
    for epoch in range(start_epoch, args.epoch):
        ...
        with torch.no_grad():
            instance_acc, table_acc, non_table_acc, test_tables, test_non_tables, test_loss = test(classifier.eval(), testDataLoader)
